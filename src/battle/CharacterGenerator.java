...
public class CharacterGenerator {
    public static List<Character> initialiseList() {
        ...
        //StatsChart statsChart, int level, int rank, String tier, Type type, Side side, String name
        ...
        characters.add(new Human(new StatsChart(60.0, 70.0, 4), 0, 61,
                "Avengers", Type.BLAST, Side.SUPER_HERO, "Iron Man"));
        characters.add(new Other(new StatsChart(60.0, 45.0, 7), 0, 90,
                "Asgardian", Type.UNIVERSAL, Side.SUPER_VILLAIN, "Loki"));
        characters.add(new Mutant(new StatsChart(80.0, 30.0, 10), 0, 85,
        ...
        characters.add(new Human(new StatsChart(80.0, 70.0, 7), 0, 45,
                "Avengers", Type.UNIVERSAL, Side.SUPER_HERO, "Dr. Strange"));
        characters.add(new Human(new StatsChart(30.0, 60.0, 6), 0, 87,
                "Self", Type.SPEED, Side.SUPER_HERO, "Wasp"));
        characters.add(new Mutant(new StatsChart(65.0, 80.0, 8), 0, 88,
